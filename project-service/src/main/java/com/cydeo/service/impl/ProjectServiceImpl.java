...
//        taskService.completeByProject(projectMapper.convertToDto(project));
    ...
    @Override
//    give a "name" for user service circuit breaker. create a fallback method with the same "fallbackMethod".
...
//    "userName" parameter should be the same as the one in listAllProjectDetails method
